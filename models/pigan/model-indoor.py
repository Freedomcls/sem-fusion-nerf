...
class ImplicitGenerator3d(nn.Module):
    ...
    def forward(self, latent_code, img_size, fov, ray_start, ray_end, num_steps, h_stddev, v_stddev, camera_pose, hierarchical_sample, opts, sample_dist=None, lock_view_dependence=False, **kwargs):
        """
    ...
    def staged_forward(self, latent_code, img_size, fov, ray_start, ray_end, num_steps, h_stddev, v_stddev, camera_pose, psi=1, lock_view_dependence=False, max_batch_size=50000, depth_map=False, near_clip=0, far_clip=2, sample_dist=None, hierarchical_sample=False, **kwargs):        
        """
